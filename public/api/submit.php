<?php
/**
 * Easy Shoping mailer — PHP 7.4 compatible (no Composer required).
...
$allowed = array(
    ...
    'http://easy-shoping.com',
    'http://www.easy-shoping.com',
    'http://localhost:3000',
    'http://127.0.0.1:3000',
);
...
$brandName = envVal('MAIL_FROM_NAME', 'Easy Shoping');
$brandColor = '#1e40af';
$border = '#e5e5e5';
$toEmail = envVal('MAIL_TO', 'info@easy-shoping.com');

if ($formType === 'contact') {
    $subject = 'New Contact Inquiry - Easy Shoping - ' . $name;
} elseif ($formType === 'newsletter' || $formType === 'cta') {
    $subject = 'New Newsletter Signup - Easy Shoping - ' . $email;
} else {
    $subject = 'New Order - Easy Shoping - ' . $name;
}
